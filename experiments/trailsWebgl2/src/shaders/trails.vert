...
vec3 getPos(float index, vec2 uv) {
    ...
    if(index < 0.5) {
        pos = texture(texture0, uv).xyz;
    } else if(index < 1.5) {
        pos = texture(texture1, uv).xyz;
    } else if(index < 2.5) {
        pos = texture(texture2, uv).xyz;
    } else if(index < 3.5) {
        pos = texture(texture3, uv).xyz;
    } else if(index < 4.5) {
        pos = texture(texture4, uv).xyz;
    } else if(index < 5.5) {
        pos = texture(texture5, uv).xyz;
    } else if(index < 6.5) {
        pos = texture(texture6, uv).xyz;
    } else if(index < 7.5) {
        pos = texture(texture7, uv).xyz;
    } else if(index < 8.5) {
        pos = texture(texture8, uv).xyz;
    } else if(index < 9.5) {
        pos = texture(texture9, uv).xyz;
    } else if(index < 10.5) {
        pos = texture(texture10, uv).xyz;
    } else if(index < 11.5) {
        pos = texture(texture11, uv).xyz;
    } else if(index < 12.5) {
        pos = texture(texture12, uv).xyz;
    } else if(index < 13.5) {
        pos = texture(texture13, uv).xyz;
    } else  {
        pos = texture(texture14, uv).xyz;
    }
...
void main(void) {
    // life
    float life = texture(textureData, aUVOffset).x;
    float t = life;
