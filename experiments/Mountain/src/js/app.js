...
let inkDrop = Math.floor(Math.random() * 42);

let assets = [
	{id:'inkMap', url:'assets/inkDrops/inkDrops'+inkDrop+'.jpg'},
	{id:'detailHeight', url:'assets/detailHeight.png'},
	{id:'noise', url:'assets/noise.png'},
