...
class ViewHead extends alfrid.View {
	...
	constructor() {
		...
		this.shaderWire.uniform("scale", "uniform3fv", [2.5, 2.5, 2.5]);
	...
	_init() {
		...
		this._objLoader.load('./assets/statue.obj', (mesh)=>this._onObjLoaded(mesh), false);

		this._objLoader1 	  = new alfrid.ObjLoader();
		this._objLoader1.load('./assets/statueSmall.obj', (meshWire)=>this._onObjWireLoaded(meshWire), false, true, GL.LINES);
	}
