...
class FluidSimulation {
	...
	_initTextures() {
		...
		this._fboVelocity   = new FboPingPong(size * 2, size, oSettings);
		this._fboDensity    = new FboPingPong(size * 2, size, oSettings);
		this._fboPressure   = new FboPingPong(size * 2, size, oSettings);
		this._fboDivergence = new alfrid.FrameBuffer(size * 2, size, oSettings);
	}
