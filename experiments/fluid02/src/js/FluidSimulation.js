...
class FluidSimulation {
	...
	_initTextures() {
		...
		this._fboVelocity   = new FboPingPong(size, size, {minFilter:GL.LINEAR, magFilter:GL.LINEAR, type});
		this._fboDensity    = new FboPingPong(size, size, {minFilter:GL.LINEAR, magFilter:GL.LINEAR, type});
		this._fboPressure   = new FboPingPong(size, size, {minFilter:GL.LINEAR, magFilter:GL.LINEAR, type});
		this._fboDivergence = new alfrid.FrameBuffer(size, size, {minFilter:GL.NEAREST, magFilter:GL.NEAREST, type});
	}
