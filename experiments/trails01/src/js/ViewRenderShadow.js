...
class ViewRender extends alfrid.View {
  ...
  render (textureCurr, textureNext, p, textureExtra, textureData) {
    this.time += 0.1
    this.shader.bind()
    ...
    this.shader.uniform('textureData', 'uniform1i', 3)
    textureData.bind(3)

    this.shader.uniform('textureMap', 'uniform1i', 4)
    Assets.get(Config.source).bind(4)
