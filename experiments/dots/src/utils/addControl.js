...
export default (scene) => {
  ...
  gui
    .add(Config, "numParticles", [64, 96, 128, 192, 256])
    .onFinishChange(reload);

  gui.add(Config, "pullForce", 0, 3).step(0.01).onFinishChange(refresh);
  gui.add(Config, "repelForce", 0, 3).step(0.01).onFinishChange(refresh);
