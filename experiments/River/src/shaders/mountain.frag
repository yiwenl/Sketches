...
/*
  ...
  const float maxFoxHeight = 0.5;
  float elevationFog = fbm(vPosition * posOffset + uTime);
  elevationFog *= 1.0 - smoothstep(0.0, maxFoxHeight, vPosition.y);
  color.rgb += elevationFog * .4;
*/
