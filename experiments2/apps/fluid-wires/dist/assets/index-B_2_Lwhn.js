...
`,Y=class{constructor(e,t,n={}){S(this,`pipeline`);let{label:r=`Compute`,layout:i=`auto`,entryPoint:a=`cs_main`}=typeof n==`string`?{label:n}:n,o=U(e,t,`${r}Shader`);this.pipeline=Se(e,{label:`${r}Pipeline`,layout:i,compute:{module:o,entryPoint:a}})}getBindGroupLayout(e=0){return this.pipeline.getBindGroupLayout(e)}dispatch(e,t,n=1){if(e.setPipeline(this.pipeline),t){let n=Array.isArray(t)?t:[t];for(let t=0;t<n.length;t++)e.setBindGroup(t,n[t].gpu)}typeof n==`number`?e.dispatchWorkgroups(n):e.dispatchWorkgroups(n[0],n[1]??1,n[2]??1)}run(e,t,n=1,r){let i=e.beginComputePass(r?{label:r}:void 0);this.dispatch(i,t,n),i.end()}},ze=class{constructor(e){if(S(this,`vertexCount`),S(this,`bindings`,[]),S(this,`indexBuffer`),S(this,`indexCount`,0),S(this,`indexFormat`,`uint16`),e<=0)throw Error(`Mesh vertexCount must be greater than 0.`);this.vertexCount=e}addVertexBuffer(e){let t=e.slot??this.nextFreeSlot();if(this.bindings.some(e=>e.slot===t))throw Error(`Vertex buffer slot ${t} is already in use.`);return this.bindings.push({...e,slot:t}),this}getVertexLayouts(){if(this.bindings.length===0)return[];let e=Math.max(...this.bindings.map(e=>e.slot)),t=Array.from({length:e+1},()=>null);for(let e of this.bindings)t[e.slot]={arrayStride:e.arrayStride,stepMode:e.stepMode??`vertex`,attributes:e.attributes.map(e=>({shaderLocation:e.shaderLocation,format:e.format,offset:e.offset}))};return t}bind(e){for(let t of this.bindings)e.setVertexBuffer(t.slot,t.buffer.gpu);this.indexBuffer&&e.setIndexBuffer(this.indexBuffer.gpu,this.indexFormat)}setIndexBuffer(e,t,n=`uint16`){if(t<=0)throw Error(`Mesh index count must be greater than 0.`);return this.indexBuffer=e,this.indexCount=t,this.indexFormat=n,this}setIndexBufferFromData(e,t,n=`mesh-indices`){let r=t instanceof Uint32Array?`uint32`:`uint16`,i=K.fromData(e,t,G.index,n);return this.setIndexBuffer(i,t.length,r),i}hasIndexBuffer(){return this.indexBuffer!==void 0}getIndexCount(){return this.indexCount}nextFreeSlot(){let e=new Set(this.bindings.map(e=>e.slot)),t=0;for(;e.has(t);)t++;return t}};function Be(e,t=`SceneUniformBindGroupLayout`){return e.gpu.createBindGroupLayout({label:t,entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}}]})}function Ve(e,t=`SceneUniformPipelineLayout`){let n=Be(e,`${t}BindGroup`);return{pipelineLayout:e.gpu.createPipelineLayout({label:t,bindGroupLayouts:[n]}),bindGroupLayout:n}}var He=class e{constructor(e,t){S(this,`textures`),S(this,`size`),this.textures=e,this.size=t}static create(t,n,r={}){let i=r.label??`Texture3DPingPong`,[a,o,s]=typeof n==`number`?[n,n,n]:n,c=Math.max(a,o,s);return new e([ke.create(t,[a,o,s],{...r,label:`${i}-write`}),ke.create(t,[a,o,s],{...r,label:`${i}-read`})],c)}get read(){return this.textures[1]}get write(){return this.textures[0]}swap(){let[e,t]=this.textures;this.textures=[t,e]}destroy(){for(let e of this.textures)e.destroy()}};function Ue(e,t){return t>65535?new Uint32Array(e):new Uint16Array(e)}var We=class{static plane(e={}){let t=e.width??1,n=e.height??1,r=Math.max(1,Math.floor(e.segmentsX??1)),i=Math.max(1,Math.floor(e.segmentsY??1)),a=[],o=[],s=[],c=[];for(let e=0;e<=i;e++)for(let c=0;c<=r;c++){let l=c/r,u=e/i,d=(l-.5)*t,f=(u-.5)*n;a.push(d,f,0),o.push(l,u),s.push(0,0,1)}let l=r+1;for(let e=0;e<i;e++)for(let t=0;t<r;t++){let n=e*l+t,r=n+1,i=n+l+1,a=n+l;c.push(n,r,i,n,i,a)}return{positions:new Float32Array(a),uvs:new Float32Array(o),normals:new Float32Array(s),indices:Ue(c,a.length/3)}}static sphere(e={}){let t=e.radius??1,n=Math.max(3,Math.floor(e.segments??12)),r=[],i=[],a=[],o=[];for(let e=0;e<=n;e++){let o=e/n,s=o*Math.PI,c=Math.cos(s),l=Math.sin(s);for(let e=0;e<=n;e++){let s=e/n,u=s*Math.PI*2,d=Math.cos(u),f=Math.sin(u),p=d*l,m=c,h=f*l;r.push(p*t,m*t,h*t),a.push(p,m,h),i.push(s,1-o)}}let s=n+1;for(let e=0;e<n;e++)for(let t=0;t<n;t++){let n=e*s+t,r=n+1,i=n+s+1,a=n+s;o.push(n,r,i,n,i,a)}return{positions:new Float32Array(r),uvs:new Float32Array(i),normals:new Float32Array(a),indices:Ue(o,r.length/3)}}static cube(e={}){let t=(e.size??1)*.5,n=[],r=[],i=[],a=[],o=0;function s(e,t,s,c,l){n.push(...e,...t,...s,...c),r.push(0,0,1,0,1,1,0,1),i.push(...l,...l,...l,...l),a.push(o+0,o+1,o+2,o+0,o+2,o+3),o+=4}return s([t,-t,-t],[t,t,-t],[t,t,t],[t,-t,t],[1,0,0]),s([-t,-t,t],[-t,t,t],[-t,t,-t],[-t,-t,-t],[-1,0,0]),s([-t,t,-t],[-t,t,t],[t,t,t],[t,t,-t],[0,1,0]),s([-t,-t,t],[-t,-t,-t],[t,-t,-t],[t,-t,t],[0,-1,0]),s([-t,-t,t],[t,-t,t],[t,t,t],[-t,t,t],[0,0,1]),s([t,-t,-t],[-t,-t,-t],[-t,t,-t],[t,t,-t],[0,0,-1]),{positions:new Float32Array(n),uvs:new Float32Array(r),normals:new Float32Array(i),indices:Ue(a,n.length/3)}}};function Ge(e=document.body){let t=document.createElement(`div`);t.style.cssText=`position:fixed;inset:0;display:flex;align-items:center;justify-content:center;padding:2rem;font:16px/1.5 system-ui,sans-serif;background:#111;color:#eee;text-align:center;`,t.textContent=`WebGPU is not available in this browser. Try the latest Chrome, Edge, or Safari.`,e.appendChild(t)}async function Ke(){if(!await xe.isSupported())throw Ge(),Error(`WebGPU is not supported.`)}var qe={TEXTURE_SIZE:32,DENSITY_DISSIPATION:.994,VELOCITY_DISSIPATION:.996,PRESSURE_DISSIPATION:.996,PRESSURE_ITERATIONS:20,CURL:5,ADVECTION_SCALE:1},X=`
...
`,ft=J.create({viewProj:`mat4x4f`,texSize:`f32`,volumeExtent:`f32`,showVelocity:`f32`,showDensity:`f32`,densityGain:`f32`,velocityThreshold:`f32`}),pt=class{mesh;device;positionBuffer;uvBuffer;indexBuffer;uniformBuffer;drawPass;bindGroupLayout;pipelineLayout;constructor(e,t={}){this.device=e;let n=t.texSize??32,r=t.volumeExtent??2,i=We.plane({width:r,height:r,segmentsX:1,segmentsY:1});this.positionBuffer=K.fromData(e,i.positions,G.vertex,`slice-plane-positions`),this.uvBuffer=K.fromData(e,i.uvs,G.vertex,`slice-plane-uvs`),this.indexBuffer=K.fromData(e,i.indices,G.index,`slice-plane-indices`),this.mesh=new ze(i.positions.length/3).addVertexBuffer({buffer:this.positionBuffer,arrayStride:12,attributes:[{shaderLocation:0,format:`float32x3`,offset:0}],slot:0,stepMode:`vertex`}).addVertexBuffer({buffer:this.uvBuffer,arrayStride:8,attributes:[{shaderLocation:1,format:`float32x2`,offset:0}],slot:1,stepMode:`vertex`}).setIndexBuffer(this.indexBuffer,i.indices.length,i.indices instanceof Uint32Array?`uint32`:`uint16`),this.uniformBuffer=K.create(e,K.uniformSize(ft.byteSize),G.uniform,`slice-plane-uniforms`);let a=GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT;this.bindGroupLayout=e.gpu.createBindGroupLayout({label:`SlicePlaneBindGroupLayout`,entries:[{binding:0,visibility:a,buffer:{type:`uniform`}},{binding:1,visibility:a,texture:{sampleType:`unfilterable-float`,viewDimension:`3d`}},{binding:2,visibility:a,texture:{sampleType:`unfilterable-float`,viewDimension:`3d`}}]}),this.pipelineLayout=e.gpu.createPipelineLayout({label:`SlicePlanePipelineLayout`,bindGroupLayouts:[this.bindGroupLayout]}),this.drawPass=new Me(e,dt,{label:`SlicePlane`,layout:this.pipelineLayout,vertexBuffers:this.mesh.getVertexLayouts(),primitive:{topology:`triangle-list`,cullMode:`none`},depthStencil:{format:`depth24plus`,depthWriteEnabled:!1,depthCompare:`less`},targets:[{format:e.format,blend:{color:{srcFactor:`src-alpha`,dstFactor:`one-minus-src-alpha`,operation:`add`},alpha:{srcFactor:`one`,dstFactor:`one-minus-src-alpha`,operation:`add`}}}]}),ft.set(`viewProj`,new Float32Array(16)).set(`texSize`,n).set(`volumeExtent`,r).set(`showVelocity`,1).set(`showDensity`,1).set(`densityGain`,14).set(`velocityThreshold`,1.2).writeToBuffer(this.uniformBuffer,e)}draw(e,t,n,r,i){ft.set(`viewProj`,r).set(`showVelocity`,+!!i.showVelocity).set(`showDensity`,+!!i.showDensity).set(`densityGain`,i.densityGain).set(`velocityThreshold`,i.velocityThreshold).writeToBuffer(this.uniformBuffer,this.device);let a=q.create(this.device,this.bindGroupLayout,[{binding:0,resource:this.uniformBuffer},{binding:1,resource:t.view},{binding:2,resource:n.view}],`slice-plane-bind-group`);this.drawPass.draw(e,this.mesh,a)}destroy(){this.positionBuffer.destroy(),this.uvBuffer.destroy(),this.indexBuffer.destroy(),this.uniformBuffer.destroy()}},mt=typeof Float32Array<`u`?Float32Array:Array;Math.PI/180,Math.hypot||(Math.hypot=function(){for(var e=0,t=arguments.length;t--;)e+=arguments[t]*arguments[t];return Math.sqrt(e)});function ht(){var e=new mt(3);return mt!=Float32Array&&(e[0]=0,e[1]=0,e[2]=0),e}function gt(e){var t=new mt(3);return t[0]=e[0],t[1]=e[1],t[2]=e[2],t}function _t(e){var t=e[0],n=e[1],r=e[2];return Math.hypot(t,n,r)}function vt(e,t){return e[0]=t[0],e[1]=t[1],e[2]=t[2],e}function yt(e,t,n){return e[0]=t[0]-n[0],e[1]=t[1]-n[1],e[2]=t[2]-n[2],e}function bt(e,t){var n=t[0],r=t[1],i=t[2],a=n*n+r*r+i*i;return a>0&&(a=1/Math.sqrt(a)),e[0]=t[0]*a,e[1]=t[1]*a,e[2]=t[2]*a,e}var xt=yt;(function(){var e=ht();return function(t,n,r,i,a,o){var s,c;for(n||=3,r||=0,c=i?Math.min(i*n+r,t.length):t.length,s=r;s<c;s+=n)e[0]=t[s],e[1]=t[s+1],e[2]=t[s+2],a(e,e,o),t[s]=e[0],t[s+1]=e[1],t[s+2]=e[2];return t}})();function St({cssWidth:e,cssHeight:t,pixelRatio:n}){let r=Number.isFinite(n)&&n>0?n:1;return{width:Math.max(1,Math.round(e*r)),height:Math.max(1,Math.round(t*r)),pixelRatio:r}}function Ct(e,t){let{width:n,height:r}=St({cssWidth:e.clientWidth,cssHeight:e.clientHeight,pixelRatio:t});return e.width===n&&e.height===r?!1:(e.width=n,e.height=r,!0)}var Z={fluidTextureSize:32,strength:150,radius:6,noiseStrength:.35,advectionScale:16,curl:6,densityDissipation:.95,velocityDissipation:.98,pressureIterations:24,wireThicknessScale:1,historyFluidStrength:.18,particleGridSize:64,wireTileCount:12,showFluidSlice:!0,showSliceVelocity:!0,showSliceDensity:!0};function wt({count:e,radius:t,baseScale:n=1,random:r=Math.random}){let i=new Float32Array(e*12),a=t*.82;for(let t=0;t<e;t++){let e=t*12,o=Tt(r),s=Math.cbrt(r())*a,c=o[0]*s,l=o[1]*s,u=o[2]*s,d=Et([-o[2]+(r()-.5)*.2,(r()-.5)*.3,o[0]+(r()-.5)*.2]),f=.018+r()*.024,p=.7+r()*.3;i[e+0]=c,i[e+1]=l,i[e+2]=u,i[e+3]=(.01+r()*.06)*2*n,i[e+4]=d[0]*f,i[e+5]=d[1]*f,i[e+6]=d[2]*f,i[e+7]=9+r()*2,i[e+8]=p,i[e+9]=p,i[e+10]=p,i[e+11]=1}return i}function Tt(e){let t=e()*2-1,n=e()*Math.PI*2,r=Math.sqrt(Math.max(0,1-t*t));return[Math.cos(n)*r,t,Math.sin(n)*r]}function Et(e){let t=Math.hypot(e[0],e[1],e[2])||1;return[e[0]/t,e[1]/t,e[2]/t]}function Dt({maxRadius:e,overshootMultiplier:t,billboardPadding:n=0}){return e*t+n}function Ot(e){return e*e}function kt(e){return e*e}function At({particleCount:e,historyLength:t}){return e*t}function jt({particles:e,particleCount:t,historyLength:n}){let r=new Float32Array(t*n*4);for(let i=0;i<n;i++)for(let n=0;n<t;n++){let a=n*12,o=(i*t+n)*4;r[o+0]=e[a+0],r[o+1]=e[a+1],r[o+2]=e[a+2],r[o+3]=1}return r}function Mt({historyLength:e,sides:t}){let n=Math.max(0,e-1),r=n*t*6,i=new Float32Array(r*3),a=new Float32Array(r*2),o=0,s=(e,t)=>{i[o*3+0]=e,i[o*3+1]=t,i[o*3+2]=0,a[o*2+0]=e,a[o*2+1]=t,o++};for(let e=0;e<n;e++)for(let n=0;n<t;n++){let r=(n+1)%t;s(e,n),s(e+1,n),s(e+1,r),s(e,n),s(e+1,r),s(e,r)}return{positions:i,nodeSides:a,vertexCount:r}}function Nt(e){return JSON.stringify(e,null,2)}function Pt(e=new Date){return`fluid-wires-settings-${e.toISOString().replace(/\.\d{3}Z$/,``).replace(`T`,`-`).replaceAll(`:`,``)}.json`}var Ft=`config`,It=class{static init(){let e=new URLSearchParams(window.location.search).get(Ft);if(e)try{let t=JSON.parse(e);if(t&&typeof t==`object`)for(let e of Object.keys(Z))e in t&&Object.assign(Z,{[e]:t[e]})}catch(e){console.warn(`Failed to parse URL config`,e)}this.refresh()}static refresh(){let e=new URLSearchParams(window.location.search);e.set(Ft,JSON.stringify(Z)),window.history.replaceState(`experiment`,document.title,`${window.location.pathname}?${e.toString()}${window.location.hash}`)}static reload(){window.location.href=window.location.origin+window.location.pathname+`?config=`+JSON.stringify(Z)}static reset(){window.location.href=window.location.pathname}static downloadCurrentConfig(){let e=Nt(Z),t=document.createElement(`a`);t.href=`data:application/json;charset=utf-8,${encodeURIComponent(e)}`,t.download=Pt(),document.body.appendChild(t),t.click(),t.remove()}},Lt=`struct Particle {
  posSize: vec4<f32>,
  velocity: vec4<f32>,
  color: vec4<f32>,
}
...
`,Ht=`${Re}\n${Rt}`,Ut=256,Q=9,Wt=Q*2,Gt=1024*2,Kt=1.35,qt=.75,Jt=.65,Yt=.002,Xt=[1,18,8],Zt=[0,0,-1],Qt=Q*.5,$t=Math.PI/180,$={maxRadius:Q*1.25,fluidForceScale:2.8,densityForceScale:.02,damping:.984,centerForce:8.4},en={time:`f32`,dt:`f32`,maxRadius:`f32`,count:`u32`,fluidForceScale:`f32`,densityForceScale:`f32`,damping:`f32`,centerForce:`f32`},tn=K.uniformSize(J.create(en).byteSize),nn={writeSlot:`u32`,historyLength:`u32`,particleCount:`u32`,radiusScale:`f32`,dt:`f32`,maxRadius:`f32`,historyFluidStrength:`f32`,densityForceScale:`f32`},rn=K.uniformSize(J.create(nn).byteSize),an=e=>J.create(en).set(`time`,0).set(`dt`,1/60).set(`maxRadius`,$.maxRadius).set(`count`,e).set(`fluidForceScale`,$.fluidForceScale).set(`densityForceScale`,$.densityForceScale).set(`damping`,$.damping).set(`centerForce`,$.centerForce);async function on(){await Ke(),It.init();let e=Ot(Z.particleGridSize),t=kt(Z.wireTileCount),n=At({particleCount:e,historyLength:t}),r=document.createElement(`canvas`);r.className=`app-canvas`,document.body.appendChild(r);let i=document.createElement(`div`);i.textContent=`${e.toLocaleString()} fluid wires`,i.className=`particle-count-label`,document.body.appendChild(i);let{fluidTextureSize:a,advectionScale:o,curl:s,densityDissipation:c,velocityDissipation:l,pressureIterations:u}=Z,d=await xe.create(r),f=new ut(d,{TEXTURE_SIZE:a,DENSITY_DISSIPATION:c,VELOCITY_DISSIPATION:l,PRESSURE_DISSIPATION:.95,PRESSURE_ITERATIONS:u,CURL:s,ADVECTION_SCALE:o},Q),p=new pt(d,{texSize:a,volumeExtent:Wt}),m=new pt(d,{texSize:a,volumeExtent:Wt}),h=wt({count:e,radius:Q}),g=jt({particles:h,particleCount:e,historyLength:t}),_=[K.fromData(d,h,G.storage,`particles-a`),K.fromData(d,h,G.storage,`particles-b`)],v=K.fromData(d,g,G.storage,`wire-history`),y=Mt({historyLength:t,sides:3}),b=K.fromData(d,y.nodeSides,G.vertex,`wire-node-sides`),x=new ze(y.vertexCount).addVertexBuffer({buffer:b,arrayStride:8,attributes:[{shaderLocation:0,format:`float32x2`,offset:0}],slot:0,stepMode:`vertex`}),S=K.create(d,K.uniformSize(ve.uniformByteSize()),G.uniform,`camera-uniforms`),C=new Float32Array(ve.uniformFloatCount),w=new ve(45*$t,1,.1,300),T=new le(w,{listenerTarget:r,center:[0,0,0],radius:Q*4,sensitivity:1,zoomSpeed:.8,panSpeed:.02});T.rx.setTo(-.22),T.ry.setTo(.72);let E=new he(We.sphere({radius:Qt,segments:24}),w,[r.width,r.height],{listenerTarget:r}),D=Z,O=!0,k=ht();E.addEventListener(`onHit`,(e=>{let t=e.detail.hit;if(O){vt(k,t),O=!1;return}let n=ht();xt(n,t,k);let r=_t(n);if(r>.001&&r<Q){let e=gt(n);bt(e,e);let i=D.strength*(r*500);f.addForce([t[0],t[1],t[2]],[e[0],e[1],e[2]],D.radius,i,1,D.noiseStrength)}vt(k,t)}));let A=new ye(-1,1,-1,1,.1,100);be({camera:A,center:[0,0,0],radius:Dt({maxRadius:Q,overshootMultiplier:Kt,billboardPadding:qt})+1,eye:Xt,up:Zt,padding:1});let ee=K.create(d,K.uniformSize(ye.uniformByteSize()),G.uniform,`light-camera-uniforms`),j=new Float32Array(ye.uniformFloatCount);A.writeUniformData(j),ee.write(d,j);let M=new ye(-1,1,-1,1,.1,100);be({camera:M,center:[0,0,0],radius:Q,eye:[0,0,Q*3],up:[0,1,0]});let N=K.create(d,tn,G.uniform,`particle-sim-params`),P=an(e),F=K.create(d,rn,G.uniform,`wire-history-params`),te=J.create(nn).set(`writeSlot`,0).set(`historyLength`,t).set(`particleCount`,e).set(`radiusScale`,Z.wireThicknessScale).set(`dt`,1/60).set(`maxRadius`,$.maxRadius).set(`historyFluidStrength`,Z.historyFluidStrength).set(`densityForceScale`,$.densityForceScale),ne=new Y(d,Lt,{label:`WireParticlesUpdate`,entryPoint:`cs_main`}),re=new Y(d,Bt,{label:`WireHistoryWrite`,entryPoint:`cs_main`}),ie=new Y(d,zt,{label:`WireHistoryAdvect`,entryPoint:`cs_main`}),I=(e,t,n,r,i)=>q.create(d,ne.getBindGroupLayout(0),[{binding:0,resource:t},{binding:1,resource:e[n]},{binding:2,resource:e[r]},{binding:3,resource:f.velocity.view},{binding:4,resource:f.density.view}],`${i}-update-${n}-to-${r}`),L=e=>q.create(d,re.getBindGroupLayout(0),[{binding:0,resource:F},{binding:1,resource:e},{binding:2,resource:v}],`wire-history-write`),R=q.create(d,ie.getBindGroupLayout(0),[{binding:0,resource:F},{binding:1,resource:v},{binding:2,resource:f.velocity.view},{binding:3,resource:f.density.view}],`wire-history-advect`),z=Ve(d,`ParticlesScene`),B=d.gpu.createBindGroupLayout({label:`WireHistoryLayout`,entries:[{binding:0,visibility:GPUShaderStage.VERTEX,buffer:{type:`read-only-storage`}},{binding:1,visibility:GPUShaderStage.VERTEX,buffer:{type:`uniform`}}]}),ae=d.gpu.createBindGroupLayout({label:`ParticlesShadowLayout`,entries:[{binding:0,visibility:GPUShaderStage.VERTEX|GPUShaderStage.FRAGMENT,buffer:{type:`uniform`}},{binding:1,visibility:GPUShaderStage.FRAGMENT,texture:{sampleType:`depth`}},{binding:2,visibility:GPUShaderStage.FRAGMENT,sampler:{type:`comparison`}}]}),oe=d.gpu.createPipelineLayout({label:`WiresShadowPipelineLayout`,bindGroupLayouts:[z.bindGroupLayout,B]}),se=d.gpu.createPipelineLayout({label:`WiresPipelineLayout`,bindGroupLayouts:[z.bindGroupLayout,B,ae]}),ce=new Ne(d,Vt,{label:`WiresShadowDraw`,layout:oe,vertexBuffers:x.getVertexLayouts(),...Ie({cullMode:`none`,depthFormat:`depth32float`})}),ue=new Me(d,Ht,{label:`WiresDraw`,layout:se,vertexBuffers:x.getVertexLayouts(),...Fe({cullMode:`none`,colorFormat:d.format})}),de=q.create(d,z.bindGroupLayout,S,0,`scene-bind-group`),fe=q.create(d,z.bindGroupLayout,ee,0,`light-scene-bind-group`),pe=q.create(d,B,[{binding:0,resource:v},{binding:1,resource:F}],`wire-history-bind-group`),me=Le.create(d,{label:`ParticlesShadowMap`,size:Gt,format:`depth32float`}),ge=K.create(d,K.uniformSize(80),G.uniform,`shadow-uniforms`),V=new Float32Array(20);V.set(A.getViewProjectionMatrix(),0),V[16]=Jt,V[17]=Gt,V[18]=Yt,ge.write(d,V);let _e=q.create(d,ae,[{binding:0,resource:ge},{binding:1,resource:me.view},{binding:2,resource:me.sampler}],`shadow-bind-group`),H=null,U=0,W=0,Se=0,Ce=0,we=performance.now(),Te=()=>{r.width===U&&r.height===W||(U=r.width,W=r.height,U>0&&W>0&&(w.setAspect(U/W),E.resolution=[U,W]))},Ee=()=>{let e=r.width,t=r.height;return H&&H.width===e&&H.height===t?H.createView():(H?.destroy(),H=d.gpu.createTexture({label:`depth-texture`,size:[e,t],format:`depth24plus`,usage:GPUTextureUsage.RENDER_ATTACHMENT}),H.createView())},De=(e,t,n)=>{if(!D.showFluidSlice||!D.showSliceVelocity&&!D.showSliceDensity)return;let r=[{visible:D.showSliceDensity,plane:p,showVelocity:!1,showDensity:!0},{visible:D.showSliceVelocity,plane:m,showVelocity:!0,showDensity:!1}].filter(e=>e.visible),i=Math.max(140,Math.min(280,Math.floor(Math.min(t,n)*.24))),a=Math.max(14,n-i-14);for(let t=0;t<r.length;t++){let n=14+t*(i+10);e.setViewport(n,a,i,i,0,1),e.setScissorRect(n,a,i,i),r[t].plane.draw(e,f.velocity,f.density,M.getViewProjectionMatrix(),{showVelocity:r[t].showVelocity,showDensity:r[t].showDensity,densityGain:6,velocityThreshold:1.2})}},Oe=i=>{null?.begin(),d.resize(),Ct(r,window.devicePixelRatio),Te();let a=Math.min(1/30,Math.max(1/240,(i-we)/1e3));we=i;let o=i*.001;P.set(`time`,o).set(`dt`,a).writeToBuffer(N,d),te.set(`writeSlot`,Ce).set(`radiusScale`,Z.wireThicknessScale).set(`dt`,a).set(`historyFluidStrength`,Z.historyFluidStrength).writeToBuffer(F,d),w.writeUniformData(C),S.write(d,C);let s=1-Se,c=d.getCurrentTexture().createView(),l=Ee(),u=d.gpu.createCommandEncoder({label:`fluid-wires-frame`});f.update(u,a);let p=u.beginComputePass({label:`update-wire-particles`});ne.dispatch(p,I(_,N,Se,s,`particles`),Math.ceil(e/Ut)),re.dispatch(p,L(_[s]),Math.ceil(e/Ut)),ie.dispatch(p,R,Math.ceil(n/Ut)),p.end();let m=me.beginRenderPass(u);ce.draw(m,x,[fe,pe],e),m.end();let h=Ae(u,c,{clearColor:{r:.015,g:.014,b:.012,a:1},depthStencilAttachment:{view:l,depthLoadOp:`clear`,depthClearValue:1,depthStoreOp:`store`}});ue.draw(h,x,[de,pe,_e],e),h.end();let g=Ae(u,c,{loadOp:`load`,depthStencilAttachment:{view:l,depthLoadOp:`clear`,depthClearValue:1,depthStoreOp:`store`}});De(g,r.width,r.height),g.end(),d.gpu.queue.submit([u.finish()]),Se=s,Ce=(Ce+1)%t,null?.end(),requestAnimationFrame(Oe)};window.addEventListener(`beforeunload`,()=>{E.disconnect(),T.destroy(),null?.destroy(),p.destroy(),m.destroy(),f.destroy(),H?.destroy(),S.destroy(),ee.destroy(),N.destroy(),F.destroy(),ge.destroy(),me.destroy(),b.destroy(),v.destroy(),_.forEach(e=>e.destroy())}),requestAnimationFrame(Oe)}on().catch(e=>{console.error(e)});