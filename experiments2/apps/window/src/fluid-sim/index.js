...
import { GL, FboPingPong, FrameBuffer, Geom, Draw } from "@alfrid";
import Scheduler from "scheduling";
import defaultSettings from "./defaultSettings.js";

// shaders
import fsAdvect from "./shaders/advect.frag.js";
...
void main(void) {
  ...
  updateFlow(mPos, mDir, mStrength = 1, mRadius = 1, mNoiseStrength = 0) {
    ...
    const time = Scheduler.getTime() * 2.0 * 0.001;
